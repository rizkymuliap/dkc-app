...
public class goalController {
    ...
    @PostMapping()
    public ResponseEntity<Object> create(@Valid @RequestBody goal data, HttpServletRequest request, BindingResult bindingResult)
    {
    ...
    @PutMapping("/{id}")
    public ResponseEntity<Object> update(@PathVariable("id") String id,@Valid @RequestBody goal data, HttpServletRequest request,  BindingResult bindingResult)
    {
        Map<String, Object> responseMap = new HashMap<>();
        try{
            String token = request.getHeader("token");
